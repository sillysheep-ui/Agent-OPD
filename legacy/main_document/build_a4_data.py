#!/usr/bin/env python3
"""build_a4_data.py — A4 corrections -> veRL parquet"""
import json
import pandas as pd
 
recs = [json.loads(l) for l in open('/root/data/alfworld/opd/a1/a3/run1/a4_corrections.jsonl')]
...
out = '/root/data/alfworld/opd/a1/a3/run1/a4_ce_train.parquet'
