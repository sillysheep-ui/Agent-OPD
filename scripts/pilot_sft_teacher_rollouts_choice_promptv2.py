...
TEACHER_SYSTEM_PROMPT_V2 = """You are an expert ALFWorld household agent.
...
OUTPUT = Path("/runs/sft_teacher_pilot_20260918_choice_promptv2_01")
        ...
        for index, (task_type, game) in enumerate(selected, 1):
            ...
            try:
                turns, won = rollout_episode(
                    ...
                    max_steps=50,
                    system_prompt=TEACHER_SYSTEM_PROMPT_V2,
